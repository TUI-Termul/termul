...
class _TuiSliderTrackState extends State<_TuiSliderTrack> {
  ...
  Widget build(BuildContext context) {
    ...
    final thumbFill = widget.enabled
    ...
    return Semantics(
      ...
      increasedValue:
          (widget.value + 1).clamp(widget.min, widget.max).toString(),
      decreasedValue:
          (widget.value - 1).clamp(widget.min, widget.max).toString(),
      onIncrease: widget.enabled
          ? () {
              ...
              if (cb == null) return;
              cb(
                (widget.value + (widget.max - widget.min) / 20)
              ...
              child: Stack(
                ...
                children: [
                  Align(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.symmetric(horizontal: _thumb / 2),
                      child: Container(
                        height: _trackH,
                        color: track,
                        alignment: Alignment.centerLeft,
