...
class TuiToastController extends ChangeNotifier {
  ...
  static TuiToastController of(BuildContext context) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<_TuiToastScope>();
    assert(
      scope != null,
  ...
  static TuiToastController read(BuildContext context) {
    final scope =
        context.getInheritedWidgetOfExactType<_TuiToastScope>();
...
class _TuiToastCardState extends State<TuiToastCard>
  ...
  Widget build(BuildContext context) {
        ...
        children: [
          ...
          Positioned(
            ...
            child: AnimatedBuilder(
              ...
              builder: (context, _) {
                final left =
                    widget.progress ?? (1.0 - (_timer?.value ?? 0.0));
                return Align(
    ...
    return Semantics(
      liveRegion: true,
      label: '${widget.type.semanticsLabel}: ${widget.title}'
