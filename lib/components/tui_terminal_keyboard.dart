          ...
          children: [
            ...
            _KeyRow(
              children: [
                ...
                _Key(label: 'ESC', flex: 10, onTap: () => _handle(TermKey.escape)),
                _Key(label: 'TAB', flex: 10, onTap: () => _handle(TermKey.tab)),
                _Key(label: 'SPACE', flex: 28, onTap: () => _handle(TermKey.space)),
                _Key(label: '←', flex: 9, onTap: () => _handle(TermKey.arrowLeft)),
                _Key(label: '↑', flex: 9, onTap: () => _handle(TermKey.arrowUp)),
                _Key(label: '↓', flex: 9, onTap: () => _handle(TermKey.arrowDown)),
                _Key(label: '→', flex: 9, onTap: () => _handle(TermKey.arrowRight)),
                _Key(label: '⏎', flex: 12, accent: true, onTap: () => _handle(TermKey.enter)),
              ],
            ),
          ],
        ),
