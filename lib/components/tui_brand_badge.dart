...
class TuiBrand {
  ...
  // —— OS ——
  static const ubuntu =
      TuiBrand(id: 'ubuntu', label: 'Ubuntu', color: Color(0xFFE95420), mark: 'Ub', glyph: 0xf31b);
  static const debian =
      TuiBrand(id: 'debian', label: 'Debian', color: Color(0xFFD70A53), mark: 'De', glyph: 0xf306);
  static const arch =
      TuiBrand(id: 'arch', label: 'Arch', color: Color(0xFF1793D1), mark: 'Ar', glyph: 0xf303);
  static const fedora =
      TuiBrand(id: 'fedora', label: 'Fedora', color: Color(0xFF3C6EB4), mark: 'Fd', glyph: 0xf30a);
  static const centos =
      TuiBrand(id: 'centos', label: 'CentOS', color: Color(0xFF932279), mark: 'Ce', glyph: 0xf304);
  static const rhel =
      TuiBrand(id: 'rhel', label: 'RHEL', color: Color(0xFFEE0000), mark: 'Rh', glyph: 0xf316);
  static const alpine =
      TuiBrand(id: 'alpine', label: 'Alpine', color: Color(0xFF0D597F), mark: 'Al', glyph: 0xf300);
  static const suse =
      TuiBrand(id: 'suse', label: 'SUSE', color: Color(0xFF4E8A1E), mark: 'Su', glyph: 0xf314);
  static const manjaro =
      TuiBrand(id: 'manjaro', label: 'Manjaro', color: Color(0xFF1F8F4A), mark: 'Mj', glyph: 0xf312);
  static const nixos =
      TuiBrand(id: 'nixos', label: 'NixOS', color: Color(0xFF5277C3), mark: 'Nx', glyph: 0xf313);
  ...
  static const freebsd =
      TuiBrand(id: 'freebsd', label: 'FreeBSD', color: Color(0xFFAB2B28), mark: 'FB', glyph: 0xf30c);
  static const macos =
      TuiBrand(id: 'macos', label: 'macOS', color: Color(0xFF6E6E73), mark: 'Mc', glyph: 0xf302);
  static const windows =
      TuiBrand(id: 'windows', label: 'Windows', color: Color(0xFF0078D4), mark: 'Wn', glyph: 0xf17a);
  static const linux =
      TuiBrand(id: 'linux', label: 'Linux', color: Color(0xFF4B5563), mark: 'Lx', glyph: 0xf31a);
  ...
  static const mongo =
      TuiBrand(id: 'mongo', label: 'MongoDB', color: Color(0xFF47A248), mark: 'Mg', glyph: 0xe7a4);
  static const redis =
      TuiBrand(id: 'redis', label: 'Redis', color: Color(0xFFDC382D), mark: 'Rd', glyph: 0xe76d);

  /// Host that has not reported an OS yet / unknown brand.
  static const unknown =
      TuiBrand(id: 'unknown', label: 'Host', color: Color(0xFF5A5A5A), mark: '∷');
...
class TuiBrandBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final markColor = known
        ? Colors.white
        : (p.isLight ? p.dim : p.text);

    final useGlyph =
        markFontFamily != null && brand.glyph != null;
